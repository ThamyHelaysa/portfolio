...
import BuyMeACoffee from '../../../components/Button/BuyMeACoffee.js'
...
Unfortunately the project was not completed. Soon after my graduation came the pandemic and many things changed that postponed the idea of continuing this project. But don't worry, you'll still see a lot of projects around here, so don't forget to come back often to check it out. 😉
